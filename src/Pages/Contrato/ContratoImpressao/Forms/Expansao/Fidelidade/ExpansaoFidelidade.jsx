...
const ExpansaoFidelidade = () => {
  ...
  return (
    <div>
      ...
      <p>Cláusula 2ª - O beneficiário do presente contrato, cursará, no ano letivo de 2023 o novo Ensino
        Médio, de acordo com a Lei 13.415 do ano de 2017.
      </p>
      ...
      <p>§ 1º - O encargo do Projeto de Vida, corresponde aos custos relacionados aos projetos desenvolvidos
        pelo estudante durante o ano letivo, desde equipamentos, materiais específicos e necessários para a
      ...
      <p>§ 1º - Os custos de transporte dos itinerários formativos serão divididos pelo número de estudantes
      ...
      <p>Cláusula 6ª – As atividades extracurriculares oferecidas durante o ano letivo de 2023 são de
        responsabilidade dos respectivos professores parceiros. Sendo assim, os comunicados,
        cancelamentos e substituições de aulas, guarda e entrega dos educandos aos responsáveis, eventuais
        acidentes que ocorram durante a atividade são obrigações dos professores de aulas extracurriculares.
      </p>
      <p>§ 1º - O CONTRATANTE responsabiliza-se em informar a ESCOLA DOS SONHOS parte CONTRATADA
        por escrito, acerca de qualquer IMPEDIMENTO de qualquer natureza, para a prática de atividades
        físicas dentro e fora do estabelecimento escolar e suas dependências, quando o aluno não apresentar
        condições para qualquer atividade.
      </p>
      ...
      <table className="contrato-table-dados-valores">
        <tr>
          <td><b>CURSO <br />NÚCLEO DE EXPANSÃO</b></td>
      ...
      <p>§ 2º - As aulas do Núcleo de Expansão que acontecerão em turno integral são obrigatórias e fazem
        parte do currículo. Os estudantes que optarem por permanecer na escola após o período da manhã
        para o contraturno, poderão almoçar na escola. O valor do almoço não está incluso na anuidade, este
        deverá ser pago diretamente na cantina da escola. Lembrando que não será permitido trazer almoço
        de casa.
      </p>
      ...
      <p>§ 3º - No caso da desistência do educando cuja anuidade foi paga de forma integral no início do ano
        ...
        Cláusula 14ª - Ao firmar o presente contrato o CONTRATANTE declara que tem total e prévio
      ...
      <p>§ 7º - Considerando que a CONTRATADA ESCOLA DOS SONHOS, fornece estacionamento sem
        qualquer tipo de cobrança aos seus usuários, esta não se responsabilizará pelos possíveis e
        hipotéticos danos causados nos veículos estacionados na escola.
      </p>
      ...
      <p>§ 1º - Para o Núcleo de Expansão o lanche é individual, seja ele trazido de casa, comprado na cantina
        da escola, ou em qualquer outro local nos dias do itinerário formativo.
      </p>
      <p>Cláusula 19ª - O educando que por eventualidade precisar de atendimento médico de emergência,
        ...
        Hospital Universitário, e ao mesmo tempo será feito contato com o CONTRATANTE para informar o
        ocorrido, o local de encaminhamento e providenciar o encontro dos pais e/ou responsáveis com a
        criança.
      </p>
...
export default ExpansaoFidelidade;