...
const DesenvolvimentoFidelidade = () => {
  ...
  return (
    <div>
      ...
      <p>§ 5º - É de exclusiva competência e responsabilidade da CONTRATADA a orientação técnica e
        ...
        será disponibilizada aos responsáveis durante a rematrícula/matrícula. A CONTRATADA fica desde
        já autorizada, a fornecer os materiais que não forem entregues pelo CONTRATANTE, cujas cobranças
        se farão quando da entrega dos mesmos ao educando, assumindo o CONTRATANTE a inteira
        responsabilidade por qualquer fato que venha a prejudicar o educando pelo descumprimento da
        obrigação.
      </p>
      <p>§ 1º - O encargo dos projetos, corresponde aos custos relacionados aos projetos desenvolvidos pelo
        ...
        Cláusula 5ª - O transporte escolar diário é de inteira responsabilidade dos pais/responsáveis,
      ...
      <table className="contrato-table-dados-valores">
        <tr>
          <td><b>CURSO <br />NÚCLEO DE DESENVOLVIMENTO</b></td>
      ...
      <p>§ 2º - As oficinas de matemática e português no contraturno são obrigatórias e fazem parte do
        ...
        participar das oficinas e/ou do laboratório de estudos, poderão almoçar na escola. O almoço do
        contraturno e o almoço dos estudantes matriculados no período integral não está incluso na
        anuidade, este deverá ser pago diretamente na cantina da escola. Lembrando que não será permitido
        o estudante trazer almoço de casa.
      </p>
      ...
      </p><p>§ 1º- Fica estabelecido que, caso o CONTRATANTE desista da matrícula antes do início do ano letivo,
        este deverá pagar uma multa de 15% sobre a anuidade por retenção de vaga.

      </p><p>§ 2º - A CONTRATADA, por liberalidade, poderá oferecer condições especiais de pagamento sem que
      ...
      <p>II. Por desarmonia entre as partes, prejudicial ao aluno, ao processo educacional ou ao bom
        ...
        III. Devido à inadimplência, conforme cláusula especifica deste contrato e Lei n. 9.870/99, artigo
...
export default DesenvolvimentoFidelidade;