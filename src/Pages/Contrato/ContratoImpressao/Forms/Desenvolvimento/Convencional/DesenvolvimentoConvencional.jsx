...
const DesenvolvimentoConvencional = () => {
  ...
  return (
    <div>
      ...
      <p>§ 2º - As oficinas de matemática e português no contraturno são obrigatórias e fazem parte do
        currículo. Os estudantes que preferirem permanecer na escola após as oficinas e os Laboratório de
        estudos poderão almoçar na escola. O valor do almoço não está incluso na anuidade, como também
        não está incluso o almoço dos estudantes do período integral, este deverá ser pago diretamente na
        cantina da escola. Lembrando que não pode ser trazido almoço de casa.
      </p>
      ...
      <p>IV. Pela emissão de duplicata de prestação de serviço, constituindo-se o contrato e o comprovante
        ...
        protesto do título.
        Cláusula 12ª - Os valores da contraprestação acima pactuada satisfazem, exclusivamente, a
...
export default DesenvolvimentoConvencional;