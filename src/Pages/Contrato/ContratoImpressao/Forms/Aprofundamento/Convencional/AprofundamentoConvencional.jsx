...
const AprofundamentoConvencional = () => {
  ...
  return (
    <div>
      ...
      <p>Cláusula 4ª - É de exclusiva responsabilidade do CONTRATANTE a aquisição do material escolar
        ...
        será disponibilizada aos responsáveis durante a matrícula ou antes do início do ano letivo. A
        CONTRATADA fica desde já autorizada, a fornecer os materiais que não forem entregues pelo
      ...
      <p>§ 5º - As despesas escolares que englobam os custos extras como alimentação, eventos, saída de
        campo ou aula passeio, uniforme, etc, devem ser pagas à vista. Caso isso não ocorra o CONTRATANTE
        tem 05 dias para fazer o pagamento no financeiro da escola e após esta data será cobrado o valor
        com acréscimo de multa de 10%.
      </p>
      ...
      <p>E por estarem às partes de acordo com todos os termos e condições do presente instrumentos,
        ...
        para que produza seus jurídicos efeitos. </p>
...
export default AprofundamentoConvencional;