...
const AprofundamentoFidelidade = () => {
  ...
  return (
    <div>
      ...
      <p>Cláusula 8ª - A anuidade poderá ser paga à vista ou parcelada e o vencimento será sempre no dia
        ...
        § 1º- Fica estabelecido que, caso o CONTRATANTE desista da rematrícula ou matrícula antes do início
...
export default AprofundamentoFidelidade;