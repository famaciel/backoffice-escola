...
const InfantilConvencional = () => {

  return (
    <div>

      <p>Cláusula 1ª - O objeto deste contrato é a prestação de serviços educacionais pela CONTRATADA, ao
      ...
      <p>§ 3º - Reserva-se a CONTRATADA, até 30 (trinta) dias antes do início de cada período letivo, o direito
      ...
      <p>§ 1º - O encargo dos Territórios de Aprendizagem, corresponde a todos os custos relacionados ao
      ...
      <p>§ 2º - Nos dias agendados para aula-passeio não haverá atividade em sala, pois tanto a professora
        quanto a professora auxiliar estarão acompanhando o grupo nesta saída de campo.
        Cláusula 6ª - O CONTRATANTE responsabiliza-se em informar a ESCOLA DOS SONHOS parte
        ...
        Cláusula 7ª - A contraprestação pelos serviços a serem prestados referentes ao período letivo de
      ...
      <table className="contrato-table-dados-valores">
        <tr>
          ...
          <td>VALOR ANUIDADE MATRÍCULA</td>
        </tr>
        <tr>
      ...
      <p>E por estarem às partes de acordo com todos os termos e condições do presente instrumentos,
...
export default InfantilConvencional;