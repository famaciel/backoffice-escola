  ...
  return (
    <div>
      ...
      <p>
        ...
        educando indicado pelo CONTRATANTE, durante o ano de 2023, de acordo com o Plano Escolar
        apresentado pela ESCOLA DOS SONHOS visando implementar um projeto político pedagógico
        durante o ano letivo contratado, definir contraprestação pecuniária e a forma de pagamento por parte
        do CONTRATANTE e estabelecer os demais dispositivos complementares.
      </p>
      <p>
        § 1º - A CONTRATADA tem sua proposta e princípio educacional orientada com base numa concepção
        multireferencialista sustentada pelos pilares da educação ambiental, arte e cidadania, conforme
        consta no Plano Escolar 2023.
      </p>
      <p>
        Cláusula 2ª - O CONTRATANTE declara estar ciente e de acordo que, para o ano letivo de 2023, à
      ...
      <p>
        Cláusula 3ª - A CONTRATADA assegura ao CONTRATANTE uma vaga no seu corpo discente, a ser
        utilizada conforme especificado na ficha de rematrícula, que passa a fazer parte integrante do
        presente contrato, ministrando a educação através de projetos de pesquisa e demais atividades
        escolares cujo planejamento pedagógico atenda ao disposto na legislação em vigor.
      </p>
      <p>
        § 1º - As atividades escolares serão realizadas nas dependências da Escola dos Sonhos ou locais que
        a CONTRATADA indicar, tendo em vista a natureza dos projetos e as técnicas pedagógicas que se
        fizerem necessárias.
      </p>
      <p>
        § 2o. – O CONTRATANTE declara, neste ato, que conheceu previamente as instalações físicas do
        estabelecimento.
      </p>
      <p>
        § 3º - Reserva-se a CONTRATADA, até 30 (trinta) dias antes do início de cada período letivo, o direito
        de cancelar qualquer turma cujo número de estudantes seja inferior a 07 (sete).
      </p>
      <p>
        § 4º - A prestação dos serviços educacionais, objeto deste contrato, tem seu início na data da
        assinatura do mesmo e seu término no último dia letivo previsto no calendário escolar.
      </p>
      <p>
        § 5º - É de exclusiva competência e responsabilidade da CONTRATADA a orientação técnica e
        pedagógica decorrente da prestação de serviços educacionais.
      </p>
      <p>
        Cláusula 4ª - É de exclusiva responsabilidade do CONTRATANTE a aquisição do material escolar
      ...
      <p>
        § 1º - O encargo dos Territórios de Aprendizagem, corresponde a todos os custos relacionados ao
        desenvolvimento dos temas dos territórios para as crianças durante o ano letivo, desde equipamentos
        e utensílios específicos necessários para a realização das atividades, como também mão de obra,
        construções e etc..
      </p>
      <p>
        Cláusula 5ª - O transporte escolar diário é de inteira responsabilidade dos pais, devendo ser
        ...
        responsáveis registrados na ficha de rematrícula. Caso haja alguma alteração na rotina do transporte,
      ...
      <p>
        § 1º - Os custos de transporte das aulas-passeio serão divididos pelo número de estudantes
        participantes do grupo.
      </p>
      <p>
        § 2º - Nos dias agendados para aula-passeio não haverá atividade em sala, pois tanto a professora
        quanto a professora auxiliar estarão acompanhando o grupo nesta saída de campo.
      </p>
      ...
      <p>Cláusula 7ª - A contraprestação pelos serviços a serem prestados referentes ao período letivo de
        ...
        taxativamente na cláusula 2ª, será a anuidade de:
      </p>

      <table className="contrato-table-dados-valores">
        <tr>
          <td><b>CURSO <br /> NÚCLEO DE EDUCAÇÃO INFANTIL</b></td>
          <td>VALOR ANUIDADE <br /> REMATRÍCULA</td>
        </tr>
        <tr>
          <td>ANUIDADE MEIO PERÍODO (vespertino) </td>
          <td>R$ 16.778,04</td>
        </tr>
        <tr>
          <td>ANUIDADE INTEGRAL <br /> Todos os dias manhã e tarde</td>
          <td>R$ 28.256,56</td>
        </tr>
        <tr>
          <td>ANUIDADE INTEGRAL <br /> 2x por semana</td>
          <td>R$ 23.407,30</td>
        </tr>
        <tr>
          <td>ANUIDADE INTEGRAL <br /> 3x por semana</td>
          <td>R$ 25.420,79</td>
        </tr>
        <tr>
      ...
      <p>
        § 1º - O valor da contraprestação acima pactuado poderá ser reajustado quando expressamente
      ...
      <p>§ 2º - O valor do almoço do período integral (Clube do Quintal) não está incluso na anuidade, este
        deverá ser pago diretamente na cantina da escola.
        Cláusula 8ª - A anuidade poderá ser paga à vista ou parcelada e o vencimento será sempre no dia
        05 de cada mês, conforme a tabela anexa com as informações da matrícula 2023.
      </p>
      <p>§ 1º- Fica estabelecido que, caso o CONTRATANTE desista da matrícula antes do início do ano letivo,
        este deverá pagar uma multa de 15% sobre a anuidade por retenção de vaga.
      </p>
      <p>
        § 2º - A CONTRATADA, por liberalidade, poderá oferecer condições especiais de pagamento sem que
      ...
      <p>
        § 4º - Outras formas de pagamento do valor da anuidade poderão ser objeto de acerto entre as partes,
        inclusive para atender os casos de matrícula a destempo.
      </p>
      ...
      <p>§ 8º - O deferimento de Matrícula é um ato da ESCOLA DOS SONHOS condicionado á existência de
      ...
      <p> § 9º - O planejamento, a prestação de serviços educacionais, a definição das datas e período de
        avaliação, fixação de carga horária, designação de professores, e a orientação didáticopedagógica e
        ...
        CONTRATANTE.
        Cláusula 9ª - Reserva-se a CONTRATADA em seu direito de prestar serviços de educação, de acordo
      ...
      <p>Parágrafo único - A obrigação do CONTRATANTE acima prevista se dá, inclusive, em relação à
        deficiência ocorrida ou constatada (preexistente oculta) após a celebração do presente contrato.
      </p>
      <p>Cláusula 10ª - O CONTRATANTE declara que teve conhecimento prévio das condições financeiras
      ...
      <p>Cláusula 11ª - Os pagamentos das parcelas deverão ser efetuados até o dia 05 de cada mês, em
      ...
      <p>
        § 3º - O pagamento das obrigações financeiras do CONTRATANTE comprovar-se-á mediante
      ...
      <p>
        § 5º - As despesas escolares que englobam os custos extras como alimentação, eventos, aula passeio,
      ...
      <p>§ 2º - O CONTRATANTE declara estar ciente da facultatividade do uso do uniforme escolar por parte
        ...
        segurança.
        § 3º - O não comparecimento do educando aos atos escolares ora contratados não o exime do
      ...
      <p>Cláusula 17ª - A CONTRATADA somente se responsabiliza pelos educandos nas dependências da
        escola dentro do horário letivo do turno matutino, vespertino ou integral, conforme matrícula. Após
        esse horário será cobrada uma taxa extra no valor de R$ 20,00 (vinte reais) por meia hora ou fração
        para os alunos encaminhados para o Plantão no período matutino (até as 13h00min) e período
        vespertino (até 19h00min).
      </p>
      <p>Cláusula 18ª - O CONTRATANTE declara estar ciente do rodízio de lanche comunitário para as
        crianças da Educação Infantil, responsabilizando-se por trazer no dia preestabelecido o lanche/frutas
        para o seu grupo conforme cardápio pré-determinado, variação dos alimentos, quantidades
        necessárias e divisão dos dias do mês. Os lanches/frutas deverão chegar à cantina até às 14h00min,
        caso não consiga entregar até este horário pedimos que avisem à secretaria.
      </p>
      <p>§ 1º - O lanche/frutas deverá chegar à escola em perfeitas condições de higiene e acondicionamento.
        Caso se apresente com má qualidade como: queimado, vencido, passado, bem como em desacordo
        com o cardápio pré-determinado, este será devolvido ao CONTRATANTE e este deverá repô-lo até as
        14h00min.

      </p>
      <p>§ 2º - Por ser coletivo e com data previamente estabelecida, o lanche/frutas deverá vir para a escola
        mesmo que o educando não venha à aula. Caso não trouxer, a escola providenciará junto a cantina
        e o mesmo será cobrado dos pais e/ou responsável, conforme tabela fixada no financeiro da escola.
        Parágrafo único - Ficam proibidos para o consumo os seguintes alimentos: bolo e bolachas com
        cobertura ou recheio, frituras, balas, pirulitos, chicletes, refrigerantes, salgadinhos fritos,
        salgadinhos tipo “Elma Chips” ou qualquer guloseima deste gênero, conforme a LEI/PMF n. 5853, de
        04 de junho de 2001.
      </p>
      ...
      <p>§ 1º - Caso não se consiga contato com o CONTRATANTE pelos telefones fornecidos na ficha de
        rematrícula do educando, a escola continuará o procedimento padrão de atendimento à emergência
        de acordo com o Art. 98º do Estatuto da Criança e do Adolescente.
      </p>
      <p>§ 2º - A CONTRATADA somente se responsabiliza pelos educandos a partir do momento em que estes
        ...
        guarda ao CONTRATANTE ou seu responsável constante na ficha de rematrícula, em conformidade
        com Cláusula 5ª.
      </p>
      ...
      <p>Cláusula 22ª - A CONTRATADA será indenizada pelo CONTRATANTE por qualquer dano ou prejuízo
        ...
        Cláusula 23ª - O presente contrato vigorará no ano de 2023 e seguintes se renovado for, e poderá
      ...
      <p>
        Cláusula 24ª - A CONTRATADA, livre de quaisquer ônus para com o CONTRATANTE, poderá utilizar-se da imagem do educando beneficiário para fins exclusivos de divulgação da escola e suas atividades,
      ...
      <p>
        E por estarem às partes de acordo com todos os termos e condições do presente instrumentos,
        assinam o presente contrato, em duas vias de igual teor e forma, juntamente com duas testemunhas,
...
export default InfantilFidelidade;