...
const TransicaoConvencional = () => {
  ...
  return (
    <div>
      ...
      <p>§ 1º - A CONTRATADA tem sua proposta e princípio educacional orientada com base numa concepção
      ...
      <p>§ 3º - Reserva-se a CONTRATADA, até 30 (trinta) dias antes do início de cada período letivo, o direito
        de cancelar qualquer turma cujo número de estudantes seja inferior a 09 (nove).
      </p>
      ...
      <p>§ 1º - O encargo dos Territórios de Pesquisa, corresponde aos custos relacionados aos projetos
        desenvolvidos pelo estudante durante o ano letivo, desde equipamentos, materiais específicos
        necessários para a realização dele, vivências, oficinas, participação de especialistas no tema etc. Não
        estão dispostos nesse custo as saídas de campo, aulas passeio e alimentação relacionadas a este dia.
      </p>
      <p>Cláusula 5ª - O transporte escolar diário é de inteira responsabilidade dos pais/responsáveis,
        devendo ser respeitado os horários de entrada e saída da escola. São de responsabilidade dos
        pais/responsáveis os combinados ou acerto de caronas, bem como mudança de programação em
        relação ao transporte escolar. Solicitamos que agendem seus transportes diretamente com os
        responsáveis pelo transporte escolar ou com as caronas de terceiros, para evitarmos falhas de
        comunicação ou desencontros. A responsabilidade da escola limita-se a entregar seus educandos às
        pessoas autorizadas pelos pais e responsáveis registrados na ficha de matrícula. Caso haja alguma
        alteração na rotina do transporte, esta deverá ser comunicada com antecedência via e-mail, agenda
        ou WhatsApp, sendo necessário ainda avisar a secretaria pelo telefone.

      </p>
      <p>§ 1º - Os custos de transporte das saídas de campo e aulas-passeio serão divididos pelo número de
        estudantes participantes do grupo.
      </p>
      <p>§ 2º - Nos dias agendados para saídas de campo ou aula-passeio não haverá atividade em sala, pois
        tanto a professora quanto a professora auxiliar estarão acompanhando o grupo nesta saída de campo.
      </p>
      ...
      <table className="contrato-table-dados-valores">
        <tr>
          <td><b>CURSO <br />NÚCLEO DE TRANSIÇÃO</b></td>
      ...
      <p>§ 2º - O valor do almoço do período integral não está incluso na anuidade, este deverá ser pago
        diretamente na cantina da escola, bem como o valor do almoço no dia do laboratório de estudos.
        Lembrando que não pode ser trazido almoço de casa.
      ...
      <p>§ 7º - A matrícula realizada a partir de março, caso ainda tenha vaga, pagará o mesmo valor da
        anuidade.
      </p>
      <p>§ 8º - O deferimento de matrícula é um ato da ESCOLA DOS SONHOS condicionado a existência de
        ...
        § 9º - O planejamento, a prestação de serviços educacionais, a definição das datas e período de
      ...
      <p>§ 2º - Os serviços extraordinários efetivamente prestados ao aluno, dos quais citamos,
        ...
        Cláusula 13ª - O presente instrumento poderá ser rescindido por iniciativa do CONTRATANTE
      ...
      <p>Cláusula 17ª - A CONTRATADA somente se responsabiliza pelos educandos nas dependências da
        ...
        Cláusula 18ª - O CONTRATANTE declara estar ciente que ficam proibidos para o consumo os
      ...
      <p>§ 1º - Para o Ensino Fundamental o seu lanche é individual, seja ele trazido de casa ou comprado na
        cantina da escola.
        Cláusula 19ª - O educando que por eventualidade precisar de atendimento médico de emergência,
      ...
      <p>
        E por estarem às partes de acordo com todos os termos e condições do presente
        instrumentos, assinam o presente contrato, em duas vias de igual teor e forma, juntamente com
        duas testemunhas, para que produza seus jurídicos efeitos.
      </p>
...
export default TransicaoConvencional;