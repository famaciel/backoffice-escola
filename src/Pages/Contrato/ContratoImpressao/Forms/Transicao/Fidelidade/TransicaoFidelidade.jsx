...
const TransicaoFidelidade = () => {
  ...
  return (
    <div>
      ...
      <p>§ 2º - Nos dias agendados para aula-passeio ou saída de estudo não haverá atividade em sala, pois
      ...
      <p>Cláusula 20ª - As partes comprometem-se a comunicar, reciprocamente, por escrito e mediante
        comprovante, qualquer mudança de endereço sob pena de serem consideradas válidas as
        correspondências enviadas aos endereços constantes do presente instrumento, inclusive para os
...
export default TransicaoFidelidade;